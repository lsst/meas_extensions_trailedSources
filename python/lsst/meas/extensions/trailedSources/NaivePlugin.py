...
class SingleFrameNaiveTrailPlugin(SingleFramePlugin):
    ...
    def __init__(self, config, name, schema, metadata, logName=None):
        ...
        self.keyAngle = schema.addField(name + "_angle", type="D",
                                        doc="Angle measured CCW from +x-axis.", units="rad")
        ...
        self.keyAngleErr = schema.addField(name + "_angleErr", type="D",
                                           doc="Trail angle error.", units="rad")
